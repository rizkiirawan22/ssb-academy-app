@extends('layouts.main', ['title' => 'Ubah Organisasi', 'org' => 'active', 'data' => 'active', 'menu' => 'menu-open'])
                    ...
                    <div class="card-body p-5">
                        <form action="{{ route('admin.organisasi.update', $org->id) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        id="name" name="name" value="{{ old('name', $org->name) }}">
                                    @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <textarea class="form-control @error('address') is-invalid @enderror" id="address" name="address">{{ old('address', $org->address) }}</textarea>
                                    @error('address')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <textarea class="form-control @error('about') is-invalid @enderror" id="about" name="about">{{ old('about', $org->about) }}</textarea>
                                    @error('about')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
