    ...
    <footer class="text-center text-lg-start bg-light text-muted">
        ...
        <div class="container text-center text-md-start mt-5">
            ...
            <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                ...
                <p>
                <a href="/anggota" class="text-reset">Anggota</a>
                </p>
                <p>
                <a href="/artikel" class="text-reset">Artikel</a>
                </p>
                <p>
                <a href="/kompetisi" class="text-reset">Kompetisi</a>
                </p>
            </div>
            <!-- Grid column -->
        ...
        <!-- Copyright -->
        <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">© 2022</div>
        <!-- Copyright -->
    </footer>
    <!-- Footer -->
</section>